...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"bifrost", "masternodelist", &masternodelist, true, true, false},
        {"bifrost", "mnbudget", &mnbudget, true, true, false},
        {"bifrost", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
...
#ifdef ENABLE_WALLET
        {"bifrost", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bifrostd, or the -server option to bifrost-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9228/\n";
}
