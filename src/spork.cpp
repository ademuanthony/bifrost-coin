...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_15_BLOCK_VALUE_ENFORCEMENT) r = SPORK_15_BLOCK_VALUE_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_BLOCK_VALUE_ENFORCEMENT") return SPORK_15_BLOCK_VALUE_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_15_BLOCK_VALUE_ENFORCEMENT) return "SPORK_15_BLOCK_VALUE_ENFORCEMENT";
